function [x, error, iter, flag, lambdamax, condnumber] = Apcg_ADD_2LMAIN(x, b,br, max_it, tol,dom,dom_ov,dom_ov2,Nx,Ny,mu,A0)
...
%  error = norm( r ) / bnrm2;  
  ...
  for iter = 1:max_it                       % begin iteration
      ...
      zlocal  = applay_Aadd_inv(r,dom, dom_ov,Nx+1,Ny+1);
      z0=apply_P0(r,dom_ov2,Nx,Ny,A0);
      subplot(2,2,1)
