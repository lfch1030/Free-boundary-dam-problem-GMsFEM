function w=datadirnewx(u,dom,Nx,Ny)
w=0*u;
...
for i1=Nx
    ...
    for e=1:nel
        T=M(right(e),:);
        w(Ig(T(2)))=sumr/scr+sumd/scd;
        sumr=sumr+coeff(right(e))*( v(T(3),1)-v(T(2),1));
        w(Ig(T(3)))=sumr/scr+sumd/scd;
