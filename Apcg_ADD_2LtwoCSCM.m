function [x, error, iter, flag, lambdamax, condnumber] = Apcg_ADD_2LtwoCSCM(x, b,br, max_it, tol,dom,dom_ov,Nx,Ny,mu,A0)
...
%  error = norm( r ) / bnrm2;  
  ...
  for iter = 1:max_it                       % begin iteration
      ...
      z0=apply_P0BAD(r,dom_ov,Nx,Ny,A0);
% % %       subplot(2,2,1)
...
% pause(0.2)
     ...
     error = full(dot(r,x-x2C))  / bnrm2;            % check convergence
