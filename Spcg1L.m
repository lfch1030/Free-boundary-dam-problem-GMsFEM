function [x, error, iter, flag, lambdamax, condnumber] = Spcg(x, b,br, max_it, tol,dom,dom_ov,A0,Nx,Ny)
...
%      z  = applay_sumSIinv1L(r,dom,dom_ov,A0,Nx,Ny);
      z  = applay_sumStildeIinv1L(r,dom,dom_ov,A0,Nx,Ny);
%      z  = pc(r,iter);
     rho = (r'*z);
...
%     q=0*p;
     ...
     fprintf(' PCG Schur1L residual(%d) = %g\n',iter,error)
