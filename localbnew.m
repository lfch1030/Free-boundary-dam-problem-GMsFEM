...
coef=coeficient(txi,teta);
for i1=1:3
%    for i2=1:3
            gradUxder1der2=ub_x(i1).*der1(txi,teta)+ub_y(i1).*der2(txi,teta);
            integrand=coef.*gradUxder1der2;
            L(i1)=sum( omega.*integrand);
%    end
end
