function [x, error, iter, flag, lambdamax, condnumber] = Apcg_ADDdam(x, b,br, max_it, tol,dom,dom_ov,Nx,Ny,mu,A0,dird,deltat,N0left,N0right)
...
% % % %       hold off
% % % % pause
       z=r;%apply_A2ladd_invMS(r,dom_ov,Nx,Ny,A0,dird);
...
%      z  = pc(r,iter);
     ...
     Ap= applay_A(p,dom,Nx,Ny)+(0.5/deltat)*applay_M(p,dom,Nx,Ny)+0.5*apply_O1(p,dom,Nx,Ny,N0left,N0right);
     Ap=applay_ZeroDir(Ap,dom,Nx,Ny);
