...
z0MS=applay_Amul_nonov(z0auxMS,b,dom, dom_ov,Nx,Ny);
EMS=z0auxMS-xf;
...
z0EM=applay_Amul_nonov(z0auxEM,b,dom, dom_ov,Nx,Ny);
EEM=z0auxEM-xf;
...
z02C=applay_Amul_nonov(z0aux2C,b,dom, dom_ov,Nx,Ny);
E2C=z0aux2C-xf;
...
z02CMS2=applay_Amul_nonov(z0aux2CMS2,b,dom, dom_ov,Nx,Ny);
...
z0R=applay_Amul_nonov(z0auxR,b,dom, dom_ov,Nx,Ny);
ER=z0auxR-xf;
...
z0Rtilde=applay_Amul_nonov(z0auxRtilde,b,dom, dom_ov,Nx,Ny);
...
% 
% figure(12)
% plot_vector(z0Rtilde, dom,Nx,Ny,mu,k'); title(['RLSM(',num2str(size(A02Ctilde,1)),'), |e|_A=',num2str(eeRtilde),'   |e|_1=',num2str(ehRtilde)]) ;view(2)
% shading flat; colorbar; axis square
