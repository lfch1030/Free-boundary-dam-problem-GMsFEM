function [dom,b,nvel]=localsetting_ov2B(ax,bx,ay,by,Nx,Ny,nx,ny,mu,k1perm)
...
for i1=[1,Nx]
    for i2=1:Ny-1
     ...
     %%%    waitbar(hbarn/(Nx*Ny),hbar);
        ...
        [M,B,v,mesh,h,Igfree,Ig,free]=createmeshAS2B(nx/2,ny,intx,inty,Nx,Ny,i1,i2);
        dom(i1,i2).M=M;
        dom(i1,i2).B=B;
        dom(i1,i2).v=v;
        dom(i1,i2).mesh=mesh;
        ...
        dom(i1,i2).c=[ax+(i1)*(bx-ax)/Nx,ay+(0)*(by-ay)/Ny];
