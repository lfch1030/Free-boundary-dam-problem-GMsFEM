function [dom,dom_ov,b,bnew,xd, A0,A0MS, A0EMF,A02C,A02CMS,A02CMS2,iterlambdaEMF]=maintwo(ax,bx,ay,by,Nx,Ny,nx,ny,mu,k1perm,max_it,tol)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
bnew=b-Axd;
%bnew=applay_Aadd_inv2(bnew,dom_ov,Nx,Ny);
