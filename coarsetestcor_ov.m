...
z0MS=applay_Amul_ov(z0auxMS,b,dom, dom_ov,Nx,Ny);
EMS=z0auxMS-xf;
...
z0EM=applay_Amul_ov(z0auxEM,b,dom, dom_ov,Nx,Ny);
EEM=z0auxEM-xf;
...
z02C=applay_Amul_ov(z0aux2C,b,dom, dom_ov,Nx,Ny);
E2C=z0aux2C-xf;
...
z02CMS2=applay_Amul_ov(z0aux2CMS2,b,dom, dom_ov,Nx,Ny);
...
z0R=applay_Amul_nonov(z0R,b,dom, dom_ov,Nx,Ny);
ER=z0auxR-xf;
...
z0Rtilde=applay_Amul_ov(z0Rtilde,b,dom, dom_ov,Nx,Ny);
