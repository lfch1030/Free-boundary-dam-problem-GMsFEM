function A=BmatrixdownNOk(M,v,mesh,Boundary,mu,k1perm)
...
for i=1:length(Boundary.down)
%   waitbar(i/(2*mesh_f.ne),h)
    %%%%%%%%%%%%%%%%%%  GLOBAL NUMBERING %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    lcol=M(Boundary.down(i),:); % subdomain indexes of bases.
    %%%%%%%%%%%%%%%%%%% VELOCITY*VLOCITY STIFNESS %%%%%%%%%%%%%%%%%%%%%
    lA=localBdownNOk(M(i,:),v,mu,k1perm); % compute local part of A
