function A=BmatrixupNOk(M,v,mesh,Boundary,mu,k1perm)
...
for i=1:length(Boundary.up)
%   waitbar(i/(2*mesh_f.ne),h)
    %%%%%%%%%%%%%%%%%%  GLOBAL NUMBERING %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    lcol=M(Boundary.up(i),:); % subdomain indexes of bases.
    %%%%%%%%%%%%%%%%%%% VELOCITY*VLOCITY STIFNESS %%%%%%%%%%%%%%%%%%%%%
    lA=localBup(M(i,:),v,mu,k1perm*0+1); % compute local part of A
