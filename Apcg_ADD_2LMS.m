function [x, error, iter, flag, lambdamax, condnumber] = Apcg_ADD_2LMS(x, b,br, max_it, tol,dom,dom_ov,Nx,Ny,mu,A0)
...
%  error = norm( r ) / bnrm2;  
  ...
  for iter = 1:max_it                       % begin iteration
      ...
      z  = apply_A2ladd_invMS(r,dom_ov,Nx,Ny,A0);
%      z  = pc(r,iter);
     rho = (r'*z);
...
%      plot_vector(r, dom,Nx,Ny,mu,k); title('\alpha p')
%      pause
%      hold off

     
     error = norm( r ) / bnrm2;            % check convergence
     fprintf(' [%f, %f ]PCG2LMS residual(%d) = %g\n',norm(r),bnrm2,iter,error)
