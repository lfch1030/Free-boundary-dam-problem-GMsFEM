...
plot_vector(xf, dom,Nx,Ny,mu,k1perm); title(['Fine scale sol (',num2str(size(x2L,1)),')']) ;view(2)
shading flat; colorbar; axis square
subplot(2,2,2) 
plot_vector(z0auxMS, dom,Nx,Ny,mu,k1perm); title(['MS(',num2str(size(A0MS,1)),'), |e|_A=',num2str(eeMS),'   |e|_1=',num2str(ehMS)]) ;view(2)
shading flat; colorbar; axis square
subplot(2,2,3) 
plot_vector(z0auxEM, dom,Nx,Ny,mu,k1perm); title(['EMF(',num2str(size(A0EMF,1)),'), |e|_A=',num2str(eeEM),'  |e|_1=',num2str(ehEM)]) ;view(2)
shading flat; colorbar; axis square
subplot(2,2,4) 
plot_vector(z0aux2C, dom,Nx,Ny,mu,k1perm); title(['LSM_1(',num2str(size(A02C,1)),'), |e|_A=',num2str(ee2C),'   |e|_1=',num2str(eh2C)]) ;view(2)
shading flat; colorbar; axis square
...
shading flat; colorbar; axis square
subplot(2,2,2) 
plot_vector(z0aux2C, dom,Nx,Ny,mu,k'); title(['LSM_1(',num2str(size(A02C,1)),'), |e|_A=',num2str(ee2C),'   |e|_1=',num2str(eh2C)]) ;view(2)
shading flat; colorbar; axis square
% % subplot(2,2,3) 
% % plot_vector(z0aux2CMS2, dom,Nx,Ny,mu,k'); title(['LSM-RE(',num2str(size(A02CMS2,1)),'), |e|_A=',num2str(ee2CMS2),'   |e|_1=',num2str(eh2CMS2)]) ;view(2)
% % shading flat; colorbar; axis square
subplot(2,2,4) 
plot_vector(z0auxR, dom,Nx,Ny,mu,k'); title(['RLSM(',num2str(size(A02Cr,1)),'), |e|_A=',num2str(eeR),'   |e|_1=',num2str(ehR)]) ;view(2)
shading flat; colorbar; axis square

% % figure(10)
% % plot_vector(z0auxRtilde, dom,Nx,Ny,mu,k'); title(['RLSM(',num2str(size(A02Ctilde,1)),'), |e|_A=',num2str(eeRtilde),'   |e|_1=',num2str(ehRtilde)]) ;view(2)
%shading flat; colorbar; axis square
...
tb(n,add+1).EnergyE=EnergyE;
tb(n,add+1).L2weigE=L2weigE;
tb(n,add+1).H1E=H1E;
tb(n,add+1).L2E=L2E;
tb(n,add+1).dim2C=size(A02C,2);
tb(n,add+1).dim2Ctilde=size(A02Ctilde,2);
