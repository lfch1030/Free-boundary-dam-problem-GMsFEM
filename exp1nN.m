...
[dom,dom_ov,b,xd, A0,A0MS, A0EMF,A02C,A02CMS,A02CMS2]=maintwo(ax,bx,ay,by,Nx,Ny,nx,ny,mu,k1perm,max_it,tol);
...
%iterlambdaEMF
S(n,N).iter=[iter1L, iter2L,iterMS,  iterEM,iter2C,iter2CMS,iter2CMS2]
% Siter(n,N)=iter2L;

S(n,N).cond=[condnumber1L,condnumber2L,condnumberMS,condnumberEM,condnumber2C, condnumber2CMS,condnumber2CMS2 ];
S(n,N).SC=size(A02C);
