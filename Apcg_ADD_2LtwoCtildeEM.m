function [x, error, iter, flag, lambdamax, condnumber] = Apcg_ADD_2LtwoCtildeEM(x, b,br, max_it, tol,dom,dom_ov,Nx,Ny,mu,A0)
...
%  error = norm( r ) / bnrm2;  
  ...
  for iter = 1:max_it                       % begin iteration
      ...
      z0=apply_P0BADtildeEM(r,dom_ov,Nx,Ny,A0);
% % % % % %            Az0= applay_A(z0,dom,Nx,Ny);
% % % % % %            ENZ0=full(dot(Az0,z0));
% % % % % %           fprintf('ENz0=%.6f \n',ENZ0);
