function [x, error, iter, flag, lambdamax, condnumber] = Apcg_ADD_2LEMF(x, b,br, max_it, tol,dom,dom_ov,Nx,Ny,mu,A0)
...
%  error = norm( r ) / bnrm2;  
  ...
  fprintf(' PCG2LEMF residual(%d) = %g\n',iter,error)
  if ( error < tol ) return, end

  for iter = 1:max_it                       % begin iteration
      
%         if iter==2
%             [dom_ov,iterlambdaEMF]=emfgen(dom,dom_ov,Nx,Ny,b,mu,x);
%             A0=coarse_matrix_EMF(dom,dom_ov,Nx,Ny);
%         end

      zlocal  = apply_A2ladd_invEMF(r,dom_ov,Nx,Ny,A0);
      z0=apply_P0EMF(r,dom_ov,Nx,Ny,A0);
% % %       subplot(2,2,1)
