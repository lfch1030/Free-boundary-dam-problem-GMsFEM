function [x, error, iter, flag, lambdamax, condnumber] = Apcg(x, b,br, max_it, tol,dom,dom_ov,Nx,Ny)
...
%  error = norm( r ) / bnrm2;  
  ...
  for iter = 1:max_it                       % begin iteration
      ...
      z  = applay_Aadd_inv(r,dom_ov,Nx-1,Ny-1);
%      z  = pc(r,iter);
     rho = (r'*z);
...
plot_vector(x,dom_ov,Nx-1,Ny-1);
%axis([-1,1,-1,1,-1,1])
%pause(0.2)
hold off
  end
