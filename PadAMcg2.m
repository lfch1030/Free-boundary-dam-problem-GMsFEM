function [x, error, iter, flag, lambdamax, condnumber] = PadAMcg2(x, b,br, max_it, tol,dom,dom_ov,Nx,Ny)
...
%                           1 = no convergence given max_it
  ...
  Ax=applay_AMadd_inv2(x,dom_ov,Nx,Ny);
%  r=0*b;
  r = b -Ax;
...
%      paux=applay_A(p,dom,Nx,Ny);
     Ap=applay_AMadd_inv2(p,dom_ov,Nx,Ny);
%     q=0*p;
     q=Ap;
     alpha(iter) = rho / (p'*q );
